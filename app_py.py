...
if st.button("Optimize Layout & Generate Report", type="primary"):
    with st.spinner("Running AI optimization..."):
        try:
            ...
            url = f"https://developer.nrel.gov/api/pvwatts/v8.json?api_key=DEMO_KEY&lat={lat}&lon={lon}&system_capacity={capacity_kw}&azimuth=180&tilt=25&module_type=0&losses=14.0
